		...
		panel_8.setLayout(
				new FormLayout(
						new ColumnSpec[] { new ColumnSpec(ColumnSpec.FILL,
								Sizes.bounded(Sizes.DEFAULT, Sizes.constant("20px", true),
										Sizes.constant("300px", true)),
								1), ColumnSpec.decode("50px"), },
...
//		LISTNERS -----------------------
		...
		final AbstractButton[] buttonsDeclencheursTraitement = { btnDecalage, btnPlayfair, rdbtnCryptage,
				rdbtnDecryptage };
		...
		final JTextField[] textFieldsDeclencheursTraitementFichier = { textFieldMotClef2, textFieldSource,
				textFieldCible };
		...
		btnSelectSource.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				FileExplorer.launch(frmCryptage, textFieldSource, new Directory(EXEC_DIRECTORY));
			}
		});

		btnSelectCible.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				FileExplorer.launch(frmCryptage, textFieldCible, new Directory(EXEC_DIRECTORY));
			}
		});
